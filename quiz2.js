...
push(); adds to the beginning of an object.
pop(); removes from the end of an object.
// Name and describe the two main operations of a queue (to add and remove data).
enqueue(); adds a value to the beginning of a queue.
dequeue(); removes the first value of a queue.
// Draw the tree resulting from adding the following sequence of numbers to an empty tree: 30, 45, 15, 10, 50, 40, 20, 27
// 10, 15, 20, 27, 30, 40, 45, 50
                                            //              30
                                            //            /    \        
                                            //          20      45
                                            //         /  \    /  \
